    ...
    public function block(block_contents $bc, $region) {
        ...
        if (empty($skiptitle)) {
            ...
            $output = html_writer::tag('a', get_string('skipa', 'access', $skiptitle),
                      array('href' => '#', 'class' => 'skip skip-block', 'id'=>'fsb-' . $bc->skipid,
                      'data-target' => '#sb-'.$bc->skipid));
            $skipdest = html_writer::tag('span', '',
                      array('id' => 'sb-' . $bc->skipid, 'class' => 'skip-block-to', 'tabindex' => '-1'));
        }
...
EOD;
    ...
    public function skip_link_target($id = null) {
        return html_writer::tag('span', '', array('id' => $id, 'tabindex' => '-1'));
    }
