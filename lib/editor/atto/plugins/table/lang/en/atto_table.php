...
$string['allowbackgroundcolor'] = 'Allow background color';
$string['allowbackgroundcolor_desc'] = 'Allow users to set the background color for the table';
...
$string['allowbordercolor'] = 'Allow border color';
$string['allowbordercolor_desc'] = 'Allow users to set the color of the borders on tables. If this is not checked, but allowborder is checked, the default color is black.<br>NOTE that this setting will not have an impact unless allowborder is checked';
$string['backgroundcolor'] = 'Background Hex';
$string['both'] = 'Both';
$string['bordercolor'] = 'Border Color Hex';
$string['borders'] = 'Borders';
$string['bordersize'] = 'Size of borders';
$string['borderstyle'] = 'Style of borders';
$string['borderstyles_desc'] = 'Allowed border styles, separated by semicolons';
